...
INSERT INTO PROPERTY_UPDATE_RECORD_MODEL (id, creation_time, modification_time, field, new_value, old_value, property_id)
values (900004, current_timestamp, current_timestamp, 'displayStatus', 'Sold STC', '', 800001 );

INSERT INTO PROPERTY_UPDATE_RECORD_MODEL (id, creation_time, modification_time, field, new_value, old_value, property_id)
values (900005, current_timestamp, current_timestamp, 'displayStatus', 'Sold STC', '', 800002 );

INSERT INTO PROPERTY_UPDATE_RECORD_MODEL (id, creation_time, modification_time, field, new_value, old_value, property_id)
values (900006, current_timestamp, current_timestamp, 'displayStatus', 'Sold STC', '', 800003 );
