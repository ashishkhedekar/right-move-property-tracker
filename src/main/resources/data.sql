...
values (800001, current_timestamp, current_timestamp, '20000', '3', 'RENT', '10', 'Buckingham', '£20,000', 'Let agreed', TO_DATE('2020-06-30','yyyy-MM-dd'), TO_DATE('2020-10-30','yyyy-MM-dd'), '',TO_DATE('2020-10-30','yyyy-MM-dd'),'false', '800001', '', '', '', true, '');

INSERT INTO PROPERTIES (ID, CREATION_TIME, MODIFICATION_TIME, AMOUNT, BEDROOMS, CHANNEL, DAYS_ON_MARKET, DISPLAY_ADDRESS, DISPLAY_PRICE, DISPLAY_STATUS, FIRST_VISIBLE_DATE, LAST_PROPERTY_UPDATE_RECEIVED, MAIN_MAP_IMAGE_SRC, OFF_MARKET_DATE, ON_MARKET, PROPERTY_ID, PROPERTY_SUB_TYPE, PROPERTY_TYPE, PROPERTY_URL, REGISTERED, SUMMARY)
values (800002, current_timestamp, current_timestamp, '40000', '4', 'RENT', '10', 'Buckingham', '£200,000', 'Let agreed', TO_DATE('2020-06-30','yyyy-MM-dd'), TO_DATE('2020-10-30','yyyy-MM-dd'), '',TO_DATE('2020-10-30','yyyy-MM-dd'),'false', '800002', '', '', '', true, '');

-- Create properties for sale

INSERT INTO PROPERTIES (ID, CREATION_TIME, MODIFICATION_TIME, AMOUNT, BEDROOMS, CHANNEL, DAYS_ON_MARKET, DISPLAY_ADDRESS, DISPLAY_PRICE, DISPLAY_STATUS, FIRST_VISIBLE_DATE, LAST_PROPERTY_UPDATE_RECEIVED, MAIN_MAP_IMAGE_SRC, OFF_MARKET_DATE, ON_MARKET, PROPERTY_ID, PROPERTY_SUB_TYPE, PROPERTY_TYPE, PROPERTY_URL, REGISTERED, SUMMARY)
values (800003, current_timestamp, current_timestamp, '585000', '4', 'BUY', '2', 'Woodlands Crescent, Buckingham', '£585,000', 'Sold STC', TO_DATE('2020-06-30','yyyy-MM-dd'), TO_DATE('2020-10-30','yyyy-MM-dd'), '',TO_DATE('2020-10-30','yyyy-MM-dd'),'false', '800003', 'Detached', '', '', true, '');

INSERT INTO PROPERTIES (ID, CREATION_TIME, MODIFICATION_TIME, AMOUNT, BEDROOMS, CHANNEL, DAYS_ON_MARKET, DISPLAY_ADDRESS, DISPLAY_PRICE, DISPLAY_STATUS, FIRST_VISIBLE_DATE, LAST_PROPERTY_UPDATE_RECEIVED, MAIN_MAP_IMAGE_SRC, OFF_MARKET_DATE, ON_MARKET, PROPERTY_ID, PROPERTY_SUB_TYPE, PROPERTY_TYPE, PROPERTY_URL, REGISTERED, SUMMARY)
values (800004, current_timestamp, current_timestamp, '350000', '4', 'BUY', '2', 'Cecil''s Yard, Buckingham', '£350,000', 'Sold STC', TO_DATE('2020-06-30','yyyy-MM-dd'), TO_DATE('2020-10-30','yyyy-MM-dd'), '',TO_DATE('2020-10-30','yyyy-MM-dd'),'false', '800004', 'Detached', '', '', true, '');
